...
\rhead{
  \begin{tikzpicture}[remember picture, overlay]
    \node [yshift=-0.45in, xshift=-1in, anchor=south east, font=\fontsize{9.5}{11}\selectfont\bfseries\ttfamily\color{black}] at (current page.north east) {\MakeUppercase{Interactive Geospatial Mapping Tool}};
  \end{tikzpicture}
}
\lfoot{
  \begin{tikzpicture}[remember picture, overlay]
